  ...
  return (
    <div>
      ...
      <div className='w-[700px] h-[580px] bg-white absolute top-[130px] left-[450px] rounded-[4%] border-0 border-black shadow-2xl'>
        ...
        className='h-[40px] w-[620px] bg-blue-500 rounded-lg pl-3 ml-10 mr-10 text-center mt-5'>Submit</button>
        
        <div className='flex text-center ml-[290px] mt-10 '>
           <FaTwitter className='m-2 text-blue-500 h-[20px] w-[20px] hover:scale-150' />
           <FaFacebookF className='m-2 text-blue-500 h-[20px] w-[20px] hover:scale-150'/>
           <FaGoogle className='m-2 text-blue-500 h-[20px] w-[20px] hover:scale-150'/>
           <FaInstagram className='m-2 text-blue-500 h-[20px] w-[20px] hover:scale-150'/>
